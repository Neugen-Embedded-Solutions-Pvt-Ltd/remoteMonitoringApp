...
const tableQueries = {
  ...
  temperatureRecordsQuery:
    "CREATE TABLE IF NOT EXISTS `temperature_records` ( `id` int(11) NOT NULL AUTO_INCREMENT, `record_date` date NOT NULL, `temperature` decimal(5,2) DEFAULT NULL, `min_temperature` decimal(5,2) DEFAULT NULL, `max_temperature` decimal(5,2) DEFAULT NULL, `conditions` varchar(200) NOT NULL, `created_at` timestamp NOT NULL DEFAULT current_timestamp(), PRIMARY KEY (`id`) ) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;",
};
